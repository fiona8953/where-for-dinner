...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=fiona8953&repo=where-for-dinner","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4193433882719753344, --data-values-file, /tmp/accelerator-options15553535838983889993.json, --output-files, /tmp/ytt-output18386851709989282911]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=fiona8953&repo=where-for-dinner'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=fiona8953&repo=where-for-dinner","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5891277468492262355, --data-values-file, /tmp/accelerator-options4692211606436679062.json, --output-files, /tmp/ytt-output14770517442919868354]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=fiona8953&repo=where-for-dinner","dynamicMsgBroker":false,"dbType":"h2","enableCloudEvents":false,"enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input12015244218677836854, --data-values-file, /tmp/accelerator-options7975072561406847678.json, --output-files, /tmp/ytt-output5608734382313836304]
